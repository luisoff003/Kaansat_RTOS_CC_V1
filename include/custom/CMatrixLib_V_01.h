...
// matriz temporal para determinante, se definirá en el Main
matrix_double temp_matrixDetDouble1;
matrix_float temp_matrixInv1;
matrix_double temp_matrixInvDouble1;
// temp matrix2 for computing the covariance matrix
matrix_float temp_matrixInv2;
matrix_double temp_matrixInvDouble2;
...
int matrix_double_inverse(matrix_double * a);
